...
8. Mobile Interaktionen f�r Ordner: Auf Touch-Ger�ten (Mobile) muss das erste Antippen eines Ordners (.mw-folder) die �ffnungs-Animation ausl�sen und einen wei� pulsierenden Glow erzeugen (.is-open und .pulse-white Klassen werden hinzugef�gt). Erst das zweite Antippen auf den bereits offenen Ordner f�hrt den Link aus (Navigation).
